...
def X as list of list of float init [
    [1.0, 1.0],
    [2.0, 1.0],
    [1.0, 2.0],
    [3.0, 2.0],
...
io.printf(
    "linreg coefficients  = %v intercept = %f|prec=0\n",
    ml.coefficients($reg),
    ml.intercept($reg));
...
def CX as list of list of float init [
    [1.0, 1.0],
    [1.5, 2.0],
    [2.0, 1.0],
    [8.0, 8.0],
...
io.printf(
    "accuracy=%f|prec=3 precision=%f|prec=3 recall=%f|prec=3 f1=%f|prec=3\n",
    ml.accuracy($yt, $yp),
    ml.precision($yt, $yp, 1),
    ml.recall($yt, $yp, 1),
    ml.f1($yt, $yp, 1));
io.printf(
    "rocAuc(perfect)      = %f|prec=1\n",
